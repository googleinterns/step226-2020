...
public class LoginServletTest {
   ...
   * UserService as a dependency of the LoginServlet. */
  @InjectMocks LoginServlet loginServlet;
  ...
  public void testGetNullRequest() throws IOException {
    Throwable exception = assertThrows(IllegalArgumentException.class, () -> {
      loginServlet.doGet(null, response);
    });
  ...
  public void testGetNullResponse() throws IOException {
    ...
    Throwable exception = assertThrows(IllegalArgumentException.class, () -> {
      loginServlet.doGet(request, null);
    });
  ...
  public void testGetInvalidRedirectURL() throws IOException {
    ...
    when(userService.createLoginURL(anyString())).
